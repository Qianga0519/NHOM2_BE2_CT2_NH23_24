...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{asset('site')}}/styles/blog_single_styles.css">
<link rel="stylesheet" type="text/css" href="{{asset('site')}}/styles/blog_single_responsive.css">
@endsection
@section('js')
    <script src="{{asset('site')}}/js/blog_single_custom.js"></script>
@endsection
...
<div class="home">
    <div class="home_background parallax-window" data-parallax="scroll"
        data-image-src="{{asset('site')}}/images/blog_single_background.jpg" data-speed="0.8"></div>
</div>
            ...
            <div class="col-lg-8 offset-lg-2">
                ...
                <div class="single_post_text">
                    ...
                    <div class="single_post_quote text-center">
                        <div class="quote_image"><img src="{{asset('site')}}/images/quote.png" alt=""></div>
