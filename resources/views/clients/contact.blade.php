...
<script src="{{asset('site')}}/js/contact_custom.js"></script>
@endsection
            ...
            <div class="col-lg-10 offset-lg-1">
                <div
                    ...
                    <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                        <div class="contact_info_image"><img src="{{asset('site')}}/images/contact_1.png" alt=""></div>
                    ...
                    <!-- Contact Item -->
                    <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                        <div class="contact_info_image"><img src="{{asset('site')}}/images/contact_2.png" alt=""></div>
                        <div class="contact_info_content">
                    ...
                    <!-- Contact Item -->
                    <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                        <div class="contact_info_image"><img src="{{asset('site')}}/images/contact_3.png" alt=""></div>
                        <div class="contact_info_content">
