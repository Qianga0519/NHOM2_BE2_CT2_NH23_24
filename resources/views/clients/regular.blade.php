...
<!-- Home -->
@section('css')
<link rel="stylesheet" type="text/css" href="{{asset('site')}}/styles/regular_styles.css">
<link rel="stylesheet" type="text/css" href="{{asset('site')}}/styles/regular_responsive.css">
@endsection
@section('js')
<script src="{{asset('site')}}/js/regular_custom.js"></script>
@endsection
