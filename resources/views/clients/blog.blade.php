...
<!-- Home -->
@section('css')
<link rel="stylesheet" type="text/css" href="{{asset('site/styles/blog_styles.css')}}">
@endsection
@section('js')
<link rel="stylesheet" type="text/css" href="{{asset('site/styles/blog_styles.css')}}">
@endsection
<div class="home">
    <div class="home_background parallax-window" data-parallax="scroll"
        data-image-src="{{asset('site')}}/images/shop_background.jpg"></div>
        ...
        <div class="row">
            <div class="col">
                <div class="blog_posts d-flex flex-row align-items-start justify-content-between">
                    ...
                    <!-- Blog post -->
                    <div class="blog_post">
                        <div class="blog_image" style="background-image:url({{asset('site')}}/images/blog_1.jpg)"></div>
                    ...
                    <!-- Blog post -->
                    <div class="blog_post">
                        <div class="blog_image" style="background-image:url({{asset('site')}}/images/blog_2.jpg)"></div>
                    ...
                    <!-- Blog post -->
                    <div class="blog_post">
                        <div class="blog_image" style="background-image:url({{asset('site')}}/images/blog_3.jpg)"></div>
                    ...
                    <!-- Blog post -->
                    <div class="blog_post">
                        <div class="blog_image" style="background-image:url({{asset('site')}}/images/blog_4.jpg)"></div>
                    ...
                    <!-- Blog post -->
                    <div class="blog_post">
                        <div class="blog_image" style="background-image:url({{asset('site')}}/images/blog_5.jpg)"></div>
                    ...
                    <!-- Blog post -->
                    <div class="blog_post">
                        <div class="blog_image" style="background-image:url({{asset('site')}}/images/blog_6.jpg)"></div>
                    ...
                    <!-- Blog post -->
                    <div class="blog_post">
                        <div class="blog_image" style="background-image:url({{asset('site')}}/images/blog_7.jpg)"></div>
                    ...
                    <!-- Blog post -->
                    <div class="blog_post">
                        <div class="blog_image" style="background-image:url({{asset('site')}}/images/blog_8.jpg)"></div>
                    ...
                    <!-- Blog post -->
                    <div class="blog_post">
                        <div class="blog_image" style="background-image:url({{url('site/images/blog_9.jpg')}})"></div>
