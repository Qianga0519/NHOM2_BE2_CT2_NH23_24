                    ...
                    <div class="row">
                        <div class="col d-flex flex-row">
                            <div class="top_bar_contact_item">
                                <div class="top_bar_icon"><img src="{{asset('site')}}/images/phone.png" alt=""></div>+84
                               090 7XXX XXX
                            </div>
                            <div class="top_bar_contact_item">
                                <div class="top_bar_icon"><img src="{{asset('site')}}/images/mail.png" alt=""></div><a href="mailto:thanhquangtran11@gmail.com">thanhquangtran11@gmail.com</a>
                            </div>
                        ...
                        <div class="col-lg-4 col-9 order-lg-3 order-2 text-lg-left text-right">
                            <div class="wishlist_cart d-flex flex-row align-items-center justify-content-end">
                                {{-- <div class="wishlist d-flex flex-row align-items-center justify-content-end">
                                    <div class="wishlist_icon"><a href="{{route('cart')}}"><img src="{{asset('site')}}/images/heart.png" alt=""></a>
                                    </div>
                                ...
                                <div class="cart">
                                    <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                        <div class="cart_icon">
                                           <a href="{{route('cart')}}"> <img src="{{asset('site')}}/images/cart.png" alt=""></a>
                                    ...
                                    <ul class="standard_dropdown main_nav_dropdown">
                                        ...
                                        <li class="hassubs">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="{{route('singleBlog')}}">Blog Post<i class="fas fa-chevron-down"></i></a></li>
                                                <li><a href="{{route('regular')}}">Regular Post<i class="fas fa-chevron-down"></i></a></li>
                            ...
                            <div class="page_menu_content">
                                ...
                                <div class="menu_contact">
                                    <div class="menu_contact_item">
                                        <div class="menu_contact_icon"><img src="{{asset('site')}}/images/phone_white.png" alt=""></div>
                                        +38 068 005 3570
                                    </div>
                                    <div class="menu_contact_item">
                                        <div class="menu_contact_icon"><img src="{{asset('site')}}/images/mail_white.png" alt=""></div><a href="mailto:fastsales@gmail.com">fastsales@gmail.com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
                            <div class="newsletter_title_container">
                                <div class="newsletter_icon"><img src="{{asset('site')}}/images/send.png" alt=""></div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 footer_col">
                        <div class="footer_column footer_contact">
                            ...
                            <div class="footer_phone">+84
                                090 7XXX XXX</div>
                            <div class="footer_contact_text">
                                <p>Thu Duc District, Ho Chi Minh City</p>
                                <p>Greater Thu Duc District, Ho Chi Minh City</p>
                            </div>
                    ...
                    <div class="col">
                        ...
                        <div class="copyright_container d-flex flex-sm-row flex-column align-items-center justify-content-start">
                            ...
                            <div class="logos ml-sm-auto">
                                <ul class="logos_list">
                                    <li><a href="#"><img src="{{url('site')}}/images/logos_1.png" alt=""></a></li>
                                    <li><a href="#"><img src="{{url('site')}}/images/logos_2.png" alt=""></a></li>
                                    <li><a href="#"><img src="{{url('site')}}/images/logos_3.png" alt=""></a></li>
                                    <li><a href="#"><img src="{{url('site')}}/images/logos_4.png" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
